...
class TestNewsURLs(TestCase):
    ...
    def test_delete_reverse(self):
        self.assertEqual(reverse('news:delete_news', kwargs={'pk': '1234test'}), '/news/delete/1234test/')

    def test_delete_resolve(self):
        self.assertEqual(resolve('/news/delete/1234test/').view_name, 'news:delete_news')
